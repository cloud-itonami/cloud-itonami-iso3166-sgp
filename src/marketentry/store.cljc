(ns marketentry.store
  "SSoT for the SGP market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems SG" :portal "GeBIZ"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sg-entity? true :has-sg-entity? true
             :requires-uen? true :uen-verified? true
             :drafted? false :submitted? false
             :jurisdiction "SGP" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "GeBIZ"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sg-entity? true :has-sg-entity? true
             :requires-uen? true :uen-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "GeBIZ"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "SGP" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "GeBIZ"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sg-entity? true :has-sg-entity? false
             :requires-uen? true :uen-verified? true
             :drafted? false :submitted? false
             :jurisdiction "SGP" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "GeBIZ"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sg-entity? true :has-sg-entity? true
             :requires-uen? true :uen-verified? false
             :drafted? false :submitted? false
             :jurisdiction "SGP" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "GeBIZ"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-sg-entity? has-sg-entity?
                               requires-uen? uen-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-sg-entity?)  (assoc :engagement/requires-sg-entity? requires-sg-entity?)
    (some? has-sg-entity?)       (assoc :engagement/has-sg-entity? has-sg-entity?)
    (some? requires-uen?)    (assoc :engagement/requires-uen? requires-uen?)
    (some? uen-verified?)    (assoc :engagement/uen-verified? uen-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-sg-entity? :engagement/has-sg-entity?
   :engagement/requires-uen? :engagement/uen-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-sg-entity? (boolean (:engagement/requires-sg-entity? m))
     :has-sg-entity? (boolean (:engagement/has-sg-entity? m))
     :requires-uen? (boolean (:engagement/requires-uen? m))
     :uen-verified? (boolean (:engagement/uen-verified? m))
