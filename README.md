# cloud-itonami-iso3166-sgp

Open ISO 3166 Blueprint for **SGP**: Singapore.
...
tax registration, and local-content rules in Singapore, so the operator
...
- **Not the government of Singapore.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Singapore-licensed counsel
...
(ISO 3166 `SGP`). Required capabilities:
